...
if dataset.__name__ == 'UFSMDataset':
    ...
    train_ER_small, val_ER_small, test_ER_small = open_dataset('./data/ERGcollection/erg_small_20graphs.pkl')

# build the GCN model
model = GNN_GAN(nin=args.dinput,
...
policy_sl.validation_gridsearch_gnngan(val_dataset = val_dataset, dataset_type=dataset_type)
